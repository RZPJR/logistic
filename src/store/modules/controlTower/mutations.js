const mutations = {
    ...
    setFilterDetail: function(state, payload) { // disable button for Detail DRSI
        state.detail_control_tower.filter = payload;
        return state;
    },
    setDataDetail: function(state, payload) {
        state.detail_control_tower.data = payload;
        return state
    }
};
